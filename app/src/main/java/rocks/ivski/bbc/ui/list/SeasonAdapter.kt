...
class SeasonAdapter(
    ...
    override fun onBindViewHolder(holder: SeasonHolder, position: Int) {
        ...
        if (selectedFilters.contains(items[position])) {
    ...
    fun updateSelected(selection: List<Int>) {
